...
output as the golden, and the golden test re-seeds identically and asserts exact
equality. Rebuilds the device/hubert/RVC-session/rmvpe-session exactly as
rvc_worker does and writes tests/assets/rvc_golden/change_voice_golden.npz
(gitignored): the input, the seed, and the seeded output.
"""
